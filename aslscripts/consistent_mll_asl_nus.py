	...
	def test(self):
		...
		for epoch in range(0,1):
			...
			for current_target_labels in alltargetlabels:
				...
				pgd_store_folder=os.path.join(current_store_folder,'pgd_consistent_mlagmla_linf')
				...
				for i, data in enumerate(tqdm(test_dataloader)):
					...
					for jk in range(1,2):
						...
						for c in range(templabels.shape[0]):
							...
							origidx=treenodes+current_target_labels
						...
						# newlabels[:,mytargetlabels]=1-newlabels[:,mytargetlabels]lvis da
