	...
	def test(self):
		...
		for epoch in range(0,1):
			...
			for current_target_labels in alltargetlabels:
				...
				pgd_store_folder=os.path.join(current_store_folder,'pgd_consistent_gmla_linf')
				...
				for i, data in enumerate(tqdm(test_dataloader)):
					...
					if (i+1)%20==0:
						...
						tempdata.to_hdf('/mnt/raptor/hassan/data/nus/Labels/nustestlabelsconsistent.h5',key='df',mode='w')
