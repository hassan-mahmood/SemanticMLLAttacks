...
class Engine(object):
    ...
    def save_checkpoint(self, state, is_best, filename='checkpoint.pth.tar'):
        ...
        savefile='/mnt/raptor/hassan/weights/voc/sep/voc_sep_gcn_1/'+str(state['epoch'])+'.pth'
        print(savefile)
        torch.save(state, savefile)

        #torch.save(state, '/mnt/raptor/hassan/weights/nus/sep/nus_sep_gcn_1/'+str(state['epoch'])+'.pth')
    ...
    def adjust_learning_rate(self, optimizer):
        ...
        decay = 0.1 if self.state['epoch']%np.array(self.state['epoch_step'])==0 else 1.0
...
class MultiLabelMAPEngine(Engine):
    ...
    def on_end_epoch(self, training, model, criterion, data_loader, optimizer=None, display=True):
        #print('AP meter:',self.state['ap_meter'].value())
